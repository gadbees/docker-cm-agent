...
RUN \
  ...
  curl -s -L -o /opt/cloudera/parcel-cache/CDH-5.9.0-1.cdh5.9.0.p0.23-el6.parcel \
    "http://archive.cloudera.com/cdh5/parcels/5.9.0/CDH-5.9.0-1.cdh5.9.0.p0.23-el6.parcel" && \
