...
RUN \
  ...
  curl -s -L -o /opt/cloudera/parcel-cache/CDH-5.13.0-1.cdh5.13.0.p0.29-el5.parcel \
    "http://archive.cloudera.com/cdh5/parcels/5.13.0/CDH-5.13.0-1.cdh5.13.0.p0.29-el5.parcel/" && \
